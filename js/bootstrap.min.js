...
function Il() {
	var talents = ['code', 'write', 'read', 'think', 'learn', 'run', 'play', 'mathematics', 'science'];
	var currentIndex = 0;
...
if(window.innerWidth>800){const top=(window.innerHeight-document.querySelector("body").clientHeight)/2;document.querySelector("body > .container").style.top=top+"px";}
